#include "isv2motor/jetson_spi.h"
#include <stdio.h>
#include <unistd.h>
#include <signal.h>
#include <stdlib.h>
...
/* SPI INIT CONFIG */
#define SPI_CHAN        0                         //chan 0 ~ 1
#define SPI_FREQ        10000000                  //freq 0 ~ 50000000(50Mbit/s)
#define SPI_MODE        0                         //mode 0 ~ 3
#define SPI_CS_DELAY    0                         //chip selecting delay 0 ~ 1000
#define SPI_BIT_WORDS   8                         //0 ~ 32
#define SPI_LSB_FIRST   0                         //0 ~ 1
#define SPI_CS_CAHNGE   1                         //0 ~ 1
